...
gt_cpsLab = 'gtCPSLab.csv'; % GroundTruth
hector_cpsLab = 'hectorCPSLab.csv';
gmap_cpsLab = 'gmapCPSLab.csv';
karto_cpsLab = 'kartoCPSLab.csv';

%   Read and extract the messages 

gt_cpsLab_data = readtable(gt_cpsLab);
hector_cpsLab_data = readtable(hector_cpsLab);
gmap_cpsLab_data = readtable(gmap_cpsLab);
karto_cpsLab_data = readtable(karto_cpsLab);

%   Extract the timestamp column
gt_time_stamp = gt_cpsLab_data{:,1};
hector_time_stamp = hector_cpsLab_data{:,1};
gmap_time_stamp = gmap_cpsLab_data{:,1};
karto_time_stamp = karto_cpsLab_data{:,1};
...
gt_x = gt_cpsLab_data{:,2};
gt_y = gt_cpsLab_data{:,3};
gt_z = gt_cpsLab_data{:,4};

hector_x = hector_cpsLab_data{:,2};
hector_y = hector_cpsLab_data{:,3};
hector_z = hector_cpsLab_data{:,4};

gmap_x = gmap_cpsLab_data{:,2};
gmap_y = gmap_cpsLab_data{:,3};
gmap_z = gmap_cpsLab_data{:,4};

karto_x = karto_cpsLab_data{:,2};
karto_y = karto_cpsLab_data{:,3};
karto_z = karto_cpsLab_data{:,4};

%   Extract the qx, qy, qz, qw rotation columns
gt_qz = gt_cpsLab_data{:,7};
hector_qz = hector_cpsLab_data{:,7};
gmap_qz = gmap_cpsLab_data{:,7};
karto_qz = karto_cpsLab_data{:,7};
