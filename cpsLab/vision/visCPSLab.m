...
gtVisCPSLab = 'gtVisCPSLab.csv'; % GroundTruth
rtabCPSLab = 'rtabCPSLab.csv';
orbslamCPSLab = 'orbslamCPSLab.csv';

%   Read and extract the messages 

gtVisCPSLab_data = readtable(gtVisCPSLab);
rtabCPSLab_data = readtable(rtabCPSLab);
orbslamCPSLab_data = readtable(orbslamCPSLab);

% Extract the timestamp column
gt_time_stamp = gtVisCPSLab_data{:,1};
rtab_time_stamp = rtabCPSLab_data{:,1};
orbslam_time_stamp = orbslamCPSLab_data{:,1};
...
gt_x = gtVisCPSLab_data{:,2};
gt_y = gtVisCPSLab_data{:,3};
gt_z = gtVisCPSLab_data{:,4};

rtab_x = rtabCPSLab_data{:,2};
rtab_y = rtabCPSLab_data{:,3};
rtab_z = rtabCPSLab_data{:,4};

orbslam_x = orbslamCPSLab_data{:,2};
orbslam_y = orbslamCPSLab_data{:,3};
orbslam_z = orbslamCPSLab_data{:,4};

% Extract the qx, qy, qz, qw rotation columns
gt_qz = gtVisCPSLab_data{:,7};
rtab_qz = rtabCPSLab_data{:,7};
orbslam_qz = orbslamCPSLab_data{:,7};
